...
from .api_routes.trend_list_routes import TrendListApi
api.add_resource(TrendListApi, '/api/trends')

from .api_routes.facebook_routes import FacebookApi
api.add_resource(FacebookApi, '/api/facebook/search')

from .api_routes.tweet_routes import TweetApi
api.add_resource(TweetApi, '/api/tweet/<title>')
api.add_resource(TweetApi, '/api/tweet')

from .api_routes.tweet_routes import SearchTweetApi
api.add_resource(SearchTweetApi, '/api/tweet/search')

from .api_routes.tweet_routes import StreamTweetApi
api.add_resource(StreamTweetApi, '/api/tweet/stream')

from .api_routes.tweet_routes import PremiumSearchTweetApi
api.add_resource(PremiumSearchTweetApi, '/api/tweet/premuim')

from .api_routes.tweet_routes import ExportTweetsApi
api.add_resource(ExportTweetsApi, '/api/tweet/export')

from .api_routes.tweet_routes import ExtractQuoteTweetsApi
api.add_resource(ExtractQuoteTweetsApi, '/api/tweet/extract_quote')

from .api_routes.tweet_routes import RemoveTweetsDuplicatesApi
api.add_resource(RemoveTweetsDuplicatesApi, '/api/tweet/remove_dup')

from .api_routes.user_routes import UserLogin
api.add_resource(UserLogin, '/api/login')

from .api_routes.user_routes import UserRegister
api.add_resource(UserRegister, '/api/register')

from .api_routes.user_routes import UserTokenRefresh
api.add_resource(UserTokenRefresh, '/api/token_refresh')

from .api_routes.user_routes import UserLogoutRefresh
api.add_resource(UserLogoutRefresh, '/api/logout_refresh')

from .api_routes.user_routes import UserLogoutAccess
